package gn.balde.jee.blog.web.rest;

import gn.balde.jee.blog.BlogApp;
import gn.balde.jee.blog.domain.Blog;
import gn.balde.jee.blog.repository.BlogRepository;
...
public class BlogResourceIT {
    ...
    public void createBlog() throws Exception {
        ...
        assertThat(testBlog.getObject()).isEqualTo(DEFAULT_OBJECT);
    }
    ...
    @Test
    @Transactional
    public void checkObjectIsRequired() throws Exception {
        int databaseSizeBeforeTest = blogRepository.findAll().size();
        // set the field null
        blog.setObject(null);
    ...
    public void updateBlog() throws Exception {
        ...
        assertThat(testBlog.getObject()).isEqualTo(UPDATED_OBJECT);
    }
